...
счастью для нас, [ребята, которые придумали веб-компоненты][2], это Это создаёт привязку к соответствующему элементу в теневом дереве 
предусмотрели и не оставили нас на произвол судьбы. Существует множество способов
стилизовать контент в теневом дереве.
